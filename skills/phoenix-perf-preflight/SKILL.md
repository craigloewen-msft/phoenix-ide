...
| Perf fixture (`fixture-turn-one`, `fixture-heavy-prod-shape`) missing on a populated DB | `./dev.py seed --repair-fixtures` (archived fixtures stay archived — unarchive in the UI first) |
